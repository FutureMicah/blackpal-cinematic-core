...
const ASSETS: Asset[] = [
  ...
  { symbol: "TRX/USDT", name: "Tron", price: "0.1654", change: 0.84, icon: "🔻", category: "crypto", volume: "140M" },
  { symbol: "LTC/USDT", name: "Litecoin", price: "82.14", change: -0.62, icon: "Ł", category: "crypto", volume: "95M" },
  { symbol: "ATOM/USDT", name: "Cosmos", price: "8.21", change: 1.42, icon: "⚛️", category: "crypto", volume: "75M" },
  { symbol: "NEAR/USDT", name: "NEAR", price: "5.84", change: 3.04, icon: "🌐", category: "crypto", volume: "70M" },
  { symbol: "APT/USDT", name: "Aptos", price: "9.42", change: 2.18, icon: "🅰️", category: "crypto", volume: "65M" },
  { symbol: "ARB/USDT", name: "Arbitrum", price: "0.8421", change: -1.84, icon: "🔵", category: "crypto", volume: "85M" },
  { symbol: "OP/USDT", name: "Optimism", price: "1.842", change: -0.54, icon: "🔴", category: "crypto", volume: "60M" },
  { symbol: "INJ/USDT", name: "Injective", price: "24.53", change: 4.21, icon: "💉", category: "crypto", volume: "55M" },
  { symbol: "SUI/USDT", name: "Sui", price: "1.412", change: 2.84, icon: "🌊", category: "crypto", volume: "80M" },
  { symbol: "TIA/USDT", name: "Celestia", price: "8.21", change: -1.24, icon: "🌌", category: "crypto", volume: "45M" },
  { symbol: "RNDR/USDT", name: "Render", price: "7.84", change: 5.84, icon: "🎨", category: "crypto", volume: "65M" },
  { symbol: "FIL/USDT", name: "Filecoin", price: "5.42", change: -0.84, icon: "📁", category: "crypto", volume: "50M" },
  { symbol: "ICP/USDT", name: "Internet Computer", price: "11.84", change: 1.62, icon: "♾️", category: "crypto", volume: "55M" },
  { symbol: "UNI/USDT", name: "Uniswap", price: "9.84", change: 0.42, icon: "🦄", category: "crypto", volume: "70M" },
  { symbol: "AAVE/USDT", name: "Aave", price: "142.50", change: 2.31, icon: "👻", category: "crypto", volume: "60M" },
  { symbol: "MKR/USDT", name: "Maker", price: "2,841", change: 1.04, icon: "🏛️", category: "crypto", volume: "40M" },
  { symbol: "WIF/USDT", name: "dogwifhat", price: "2.45", change: 8.21, icon: "🐶", category: "crypto", volume: "120M" },
  { symbol: "BONK/USDT", name: "Bonk", price: "0.00003", change: 6.84, icon: "🐕", category: "crypto", volume: "60M" },
  { symbol: "SEI/USDT", name: "Sei", price: "0.84", change: 3.21, icon: "🌀", category: "crypto", volume: "55M" },
  { symbol: "IMX/USDT", name: "Immutable", price: "1.42", change: 2.10, icon: "🎮", category: "crypto", volume: "45M" },
  { symbol: "SAND/USDT", name: "Sandbox", price: "0.42", change: -0.84, icon: "🏖️", category: "crypto", volume: "35M" },
  // Forex majors
  ...
  { symbol: "AUD/JPY", name: "Aussie/Yen", price: "101.84", change: 0.21, icon: "🇦🇺", category: "forex" },
  { symbol: "CHF/JPY", name: "Franc/Yen", price: "174.82", change: -0.18, icon: "🇨🇭", category: "forex" },
  { symbol: "EUR/CHF", name: "Euro/Franc", price: "0.9594", change: 0.08, icon: "🇪🇺", category: "forex" },
  { symbol: "EUR/AUD", name: "Euro/Aussie", price: "1.6452", change: 0.32, icon: "🇪🇺", category: "forex" },
  { symbol: "GBP/AUD", name: "Pound/Aussie", price: "1.9132", change: -0.14, icon: "🇬🇧", category: "forex" },
  { symbol: "GBP/CHF", name: "Pound/Franc", price: "1.1162", change: -0.21, icon: "🇬🇧", category: "forex" },
  { symbol: "GBP/CAD", name: "Pound/Loonie", price: "1.7284", change: 0.18, icon: "🇬🇧", category: "forex" },
  { symbol: "EUR/CAD", name: "Euro/Loonie", price: "1.4842", change: 0.11, icon: "🇪🇺", category: "forex" },
  { symbol: "EUR/NZD", name: "Euro/Kiwi", price: "1.7984", change: 0.22, icon: "🇪🇺", category: "forex" },
  { symbol: "GBP/NZD", name: "Pound/Kiwi", price: "2.0942", change: -0.18, icon: "🇬🇧", category: "forex" },
  { symbol: "AUD/NZD", name: "Aussie/Kiwi", price: "1.0942", change: 0.04, icon: "🇦🇺", category: "forex" },
  { symbol: "AUD/CAD", name: "Aussie/Loonie", price: "0.9024", change: -0.07, icon: "🇦🇺", category: "forex" },
  { symbol: "CAD/JPY", name: "Loonie/Yen", price: "112.84", change: 0.32, icon: "🇨🇦", category: "forex" },
  { symbol: "NZD/JPY", name: "Kiwi/Yen", price: "93.21", change: 0.18, icon: "🇳🇿", category: "forex" },
  { symbol: "USD/MXN", name: "Dollar/Peso", price: "18.42", change: 0.54, icon: "🇲🇽", category: "forex" },
  { symbol: "USD/ZAR", name: "Dollar/Rand", price: "18.92", change: -0.31, icon: "🇿🇦", category: "forex" },
  { symbol: "USD/SGD", name: "Dollar/SGD", price: "1.3421", change: 0.08, icon: "🇸🇬", category: "forex" },
  { symbol: "USD/TRY", name: "Dollar/Lira", price: "32.42", change: 1.21, icon: "🇹🇷", category: "forex" },
  // Commodities
  ...
  { symbol: "UKOIL", name: "Brent Oil", price: "82.41", change: -1.21, icon: "🛢️", category: "energy" },
  { symbol: "XPT/USD", name: "Platinum", price: "984.20", change: 0.42, icon: "⚪", category: "energy" },
  { symbol: "XPD/USD", name: "Palladium", price: "1,021", change: -1.84, icon: "⚪", category: "energy" },
  // Indices
  ...
  { symbol: "UK100", name: "FTSE 100", price: "8,142", change: 0.21, icon: "🇬🇧", category: "indices" },
  { symbol: "JPN225", name: "Nikkei", price: "38,420", change: 0.84, icon: "🇯🇵", category: "indices" },
];
